...
(function() {
  $(function() {
    var processParams, pushState, refreshIFrame, updateResolution, updateUrl, updateiFrameUrl;
    ...
    updateUrl = function() {
      return $("#iframeUrl").val(document.getElementById("device").contentWindow.location.href);
    };
